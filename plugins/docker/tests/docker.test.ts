...
describe("docker plugin (real environment)", () => {
  it("reports availability without throwing in any environment", { timeout: 20_000 }, async () => {
  ...
  it("returns undefined container lists when Docker is unusable", { timeout: 20_000 }, async () => {
  ...
  it("returns undefined image lists when Docker is unusable", { timeout: 20_000 }, async () => {
